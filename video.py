...
def video():
    ...
    video_clip = VideoFileClip("finalBackground.mp4").set_duration(20)
    # Image file
    ...
    image=image.set_position((top_right_x,top_right_y)).set_duration(10)
    # Create an array of text clips
    text_clips = []

    # Define text content, duration, and position for each text clip
    text_data = [
        {"text": """ Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam aliquid dolorem blanditiis non ipsum perferendis enim.
          ...
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam aliquid dolorem blanditiis non ipsum perferendis enim.
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam aliquid dolorem blanditiis non ipsum perferendis enim.
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam aliquid dolorem blanditiis non ipsum perferendis enim.""", "duration": 5, "position": (0.5,0.5)},
    ...
    for data in text_data:
        text_clip = TextClip(data["text"], fontsize=20, color='white')
    ...
    video_with_text = CompositeVideoClip([video_clip,image] + text_clips)
